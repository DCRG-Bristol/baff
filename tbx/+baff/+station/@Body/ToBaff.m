function ToBaff(obj,filepath,loc)
    ...
    h5write(filepath,sprintf('%s/BodyStations/A',loc),obj.A,[1 1],[1 Ne]);
    h5write(filepath,sprintf('%s/BodyStations/I',loc),reshape(obj.I,9,[]),[1 1],[9 Ne]);
    h5write(filepath,sprintf('%s/BodyStations/J',loc),obj.J,[1 1],[1 Ne]);
    h5write(filepath,sprintf('%s/BodyStations/Tau',loc),reshape(obj.tau,9,[]),[1 1],[9 Ne]);
    h5write(filepath,sprintf('%s/BodyStations/Radius',loc),obj.Radius,[1 1],[1 Ne]);
